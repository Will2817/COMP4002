...
void createEntities() {
	...
	/*
	for (auto i = 0; i < 5; ++i) {
		auto tree = new TreeNaive(Vector3(-400 + i*200, 0, -400), shader2, true, images["nature_bark.png"],images["templeaf.png"]);
		entities.push_back(tree->root);
	}
	*/
	entities.push_back(new TreeLSystem(Vector3(0, 0, -300), 20, shader2, true, images["nature_bark.png"], images["templeaf.png"]));
}
